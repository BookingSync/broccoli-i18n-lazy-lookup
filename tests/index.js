...
describe('broccoli-i18n-lazy-lookup', function() {
  ...
  it("can use lazy lookup in controllers' ...Translation function", function() {
    ...
    return builder.build().then(function(dir) {
      var actual = fs.readFileSync(dir + '/app/controllers/matched-controller-file.js', { encoding: 'utf8'});
  ...
  it('can use lazy lookup in handlebar templates', function() {
    ...
    builder = new broccoli.Builder(tree);
    return builder.build().then(function(dir) {
      var actual = fs.readFileSync(dir + '/app/templates/matched-template-file.hbs', { encoding: 'utf8'});
  ...
  it("can use lazy lookup in nested controllers' ...Translation function", function() {
    ...
    builder = new broccoli.Builder(tree);
    return builder.build().then(function(dir) {
      var actual = fs.readFileSync(dir + '/app/controllers/posts/matched-controller-file.js', { encoding: 'utf8'});
  ...
  it('can use lazy lookup in nested handlebar templates', function() {
    ...
    builder = new broccoli.Builder(tree);
    return builder.build().then(function(dir) {
      var actual = fs.readFileSync(dir + '/app/templates/posts/matched-template-file.hbs', { encoding: 'utf8'});
